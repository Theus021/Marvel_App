...
import daniel.lop.io.marvelappstarter.data.remote.local.MarvelDataBase
        ...
        return OkHttpClient().newBuilder()
            .addInterceptor { chain ->
                ...
                val newUrl = chain.request().url
                    ...
                    .addQueryParameter(Constants.APIKEY, Constants.PUPLIC_KEY)
                    .addQueryParameter(Constants.HASH,
                    provideToMd5Hash(currentTimestamp.toString() + Constants.PRIVATE_KEY + Constants.PUPLIC_KEY))
                   .build()
